...
def build_system_prompt() -> str:
    return (
        ...
        "3. Categorize each word using ONLY these Fitzgerald Key categories: "
        "pronoun, verb, noun, adjective, social, question, or urgent. Words that "
        "are adverbs or descriptors (like 'now', 'here', 'more') go under "
        "'adjective'. Never invent other category names.\n"
